...
public class DatabaseUserManager implements UserManager{
	...
	private DatabaseUserManager() {
		...
		factory = DatabaseObjectFactory.getInstance(); 
	}
	...
	public User authenticate(String username, String password) {
		...
		try {
			...
			if (results.next()) {
				...
				user = factory.getNewUser(username, password, email, name, surname, isVip, isAdmin, dateBirth);	
			}
	...
	public User getUser(String username) {
		...
		try {
			...
			if (results.next()) {
				...
				user = factory.getNewUser(username, password, email, name, surname, isVip, isAdmin, birthday);
	...
	public Iterable<User> searchWith(String q){
		...
		try {
			...
			while (result.next()) {
				...
				User user = factory.getNewUser(username, "", email, name, surname, isVip, isAdmin, birth);
				ret.add(user);
